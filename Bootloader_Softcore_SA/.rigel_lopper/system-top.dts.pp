# 0 "C:\\IMR_Projects\\IMR\\Softcore_SA\\Bootloader_Softcore_SA\\MB_SSA_BL_Platform\\hw\\sdt\\system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "C:\\IMR_Projects\\IMR\\Softcore_SA\\Bootloader_Softcore_SA\\MB_SSA_BL_Platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\IMR_Projects\\IMR\\Softcore_SA\\Bootloader_Softcore_SA\\MB_SSA_BL_Platform\\hw\\sdt\\pl.dtsi" 1
/ {
 cpus_microblaze_0: cpus_microblaze@0 {
  ...
  microblaze_0: cpu@0 {
   ...
   xlnx,i-axi = <0>;
   xlnx,g-template-list = <10>;
   xlnx,icache-streams = <1>;
 ...
 amba_pl: amba_pl {
  ...
  axi_quad_spi_1: axi_quad_spi@44a00000 {
   xlnx,select-xpm = <0>;
   compatible = "xlnx,axi-quad-spi-3.2" , "xlnx,xps-spi-2.00.a";
   xlnx,lsb-stup = <0>;
  ...
  axi_quad_spi_2: axi_quad_spi@44a40000 {
   xlnx,select-xpm = <0>;
   compatible = "xlnx,axi-quad-spi-3.2" , "xlnx,xps-spi-2.00.a";
   xlnx,lsb-stup = <0>;
   xlnx,num-ss-bits = <0x1>;
...
# 3 "C:\\IMR_Projects\\IMR\\Softcore_SA\\Bootloader_Softcore_SA\\MB_SSA_BL_Platform\\hw\\sdt\\system-top.dts" 2
/ {
 device_id = "7a100t";
 #address-cells = <1>;
 #size-cells = <1>;
 ...
 cpus_microblaze_0: cpus_microblaze@0 {
  address-map = <0x00000000 &microblaze_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x20000>,
         ...
         <0x44a30000 &IMR_ADC_7476A_X2_0 0x44a30000 0x10000>,
         <0x44a40000 &axi_quad_spi_2 0x44a40000 0x10000>;

...
################################################################
# This is a generated script based on design: BD_Softcore_SA
#
...
# source BD_Softcore_SA_script.tcl
...
set design_name BD_Softcore_SA
...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_0 "This is the custom IP" [get_bd_designs $design_name]
...
proc write_mig_file_BD_Softcore_SA_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>BD_Softcore_SA_mig_7series_0_0</ModuleName>}
...
# End of write_mig_file_BD_Softcore_SA_mig_7series_0_0()
...
proc create_root_design { parentCell } {
  ...
  set RST_PB [ create_bd_port -dir I RST_PB ]
  set PB_1 [ create_bd_port -dir I PB_1 ]
  set PB_2 [ create_bd_port -dir I PB_2 ]
  set PB_3 [ create_bd_port -dir I PB_3 ]
  ...
  set DISPLAY_MOSI [ create_bd_port -dir O DISPLAY_MOSI ]
  set DISPLAY_CSn [ create_bd_port -dir O -from 0 -to 0 DISPLAY_CSn ]
  set DISPLAY_SCLK [ create_bd_port -dir O DISPLAY_SCLK ]
  set gpio2_io_o_0 [ create_bd_port -dir O -from 5 -to 0 gpio2_io_o_0 ]
  set DISPLAY_MISO [ create_bd_port -dir I DISPLAY_MISO ]
  set ADC_IRQ_DONE [ create_bd_port -dir O -from 0 -to 0 ADC_IRQ_DONE ]
  set LED_4 [ create_bd_port -dir O LED_4 ]
  set MB_RST [ create_bd_port -dir O -type rst MB_RST ]
  set MB_CLK [ create_bd_port -dir O -type clk MB_CLK ]
  set USD_MOSI [ create_bd_port -dir O USD_MOSI ]
  set USD_MISO [ create_bd_port -dir I USD_MISO ]
  set USD_CSn [ create_bd_port -dir O -from 0 -to 0 USD_CSn ]
  set USD_SCLK [ create_bd_port -dir O USD_SCLK ]
  set USD_CD [ create_bd_port -dir I USD_CD ]
  ...
  # Create instance: smartconnect_CPU, and set properties
  set smartconnect_CPU [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 smartconnect_CPU ]
  set_property -dict [list \
    CONFIG.NUM_MI {8} \
    CONFIG.NUM_SI {3} \
  ] $smartconnect_CPU
  ...
  set_property CONFIG.C_KIND_OF_INTR {0xFFFFFFF3} $axi_intc_0
  ...
  # Create instance: smartconnect_DDR3, and set properties
  set smartconnect_DDR3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 smartconnect_DDR3 ]
  set_property -dict [list \
    CONFIG.NUM_MI {2} \
    CONFIG.NUM_SI {1} \
  ] $smartconnect_DDR3
  ...
  write_mig_file_BD_Softcore_SA_mig_7series_0_0 $str_mig_file_path
  ...
  set_property CONFIG.C_USE_STARTUP {0} $axi_quad_spi_1


  # Create instance: IMR_PL_Revision_0, and set properties
  set IMR_PL_Revision_0 [ create_bd_cell -type ip -vlnv IMR:user:IMR_PL_Revision:1.0 IMR_PL_Revision_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_clock_converter_0_M_AXI [get_bd_intf_pins axi_clock_converter_0/M_AXI] [get_bd_intf_pins smartconnect_DDR3/S00_AXI]
  connect_bd_intf_net -intf_net axi_intc_0_interrupt [get_bd_intf_pins axi_intc_0/interrupt] [get_bd_intf_pins microblaze_0/INTERRUPT]
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_DC [get_bd_intf_pins microblaze_0/M_AXI_DC] [get_bd_intf_pins smartconnect_CPU/S01_AXI]
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_DP [get_bd_intf_pins microblaze_0/M_AXI_DP] [get_bd_intf_pins smartconnect_CPU/S00_AXI]
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_IC [get_bd_intf_pins microblaze_0/M_AXI_IC] [get_bd_intf_pins smartconnect_CPU/S02_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_DDR3/M00_AXI] [get_bd_intf_pins mig_7series_0/S_AXI]
  connect_bd_intf_net -intf_net smartconnect_CPU_M00_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins smartconnect_CPU/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_CPU_M01_AXI [get_bd_intf_pins smartconnect_CPU/M01_AXI] [get_bd_intf_pins axi_timer_0/S_AXI]
  connect_bd_intf_net -intf_net smartconnect_CPU_M02_AXI [get_bd_intf_pins smartconnect_CPU/M02_AXI] [get_bd_intf_pins axi_uartlite_0/S_AXI]
  connect_bd_intf_net -intf_net smartconnect_CPU_M03_AXI [get_bd_intf_pins smartconnect_CPU/M03_AXI] [get_bd_intf_pins axi_quad_spi_0/AXI_LITE]
  connect_bd_intf_net -intf_net smartconnect_CPU_M04_AXI [get_bd_intf_pins smartconnect_CPU/M04_AXI] [get_bd_intf_pins axi_intc_0/s_axi]
  connect_bd_intf_net -intf_net smartconnect_CPU_M05_AXI [get_bd_intf_pins smartconnect_CPU/M05_AXI] [get_bd_intf_pins axi_quad_spi_1/AXI_LITE]
  connect_bd_intf_net -intf_net smartconnect_CPU_M06_AXI [get_bd_intf_pins smartconnect_CPU/M06_AXI] [get_bd_intf_pins axi_clock_converter_0/S_AXI]
  connect_bd_intf_net -intf_net smartconnect_CPU_M07_AXI [get_bd_intf_pins smartconnect_CPU/M07_AXI] [get_bd_intf_pins IMR_PL_Revision_0/S00_AXI]

  # Create port connections
  connect_bd_net -net CLK_100MHZ_1  [get_bd_ports CLK_100MHZ] \
  [get_bd_pins util_ds_buf_0/BUFG_I]
  connect_bd_net -net DISPLAY_MISO_1  [get_bd_ports DISPLAY_MISO] \
  [get_bd_pins axi_quad_spi_0/io1_i]
  connect_bd_net -net PB_1_1  [get_bd_ports PB_1] \
  [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net PB_2_1  [get_bd_ports PB_2] \
  [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net PB_3_1  [get_bd_ports PB_3] \
  [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net RST_PB_1  [get_bd_ports RST_PB] \
  [get_bd_pins util_vector_logic_0/Op1] \
  [get_bd_pins clk_wiz_1/reset]
  connect_bd_net -net SW_0_1  [get_bd_ports SW_0] \
  [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net SW_1_1  [get_bd_ports SW_1] \
  [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net USD_CD_1  [get_bd_ports USD_CD] \
  [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net axi_gpio_0_gpio2_io_o  [get_bd_pins axi_gpio_0/gpio2_io_o] \
  [get_bd_ports gpio2_io_o_0] \
  [get_bd_pins xlslice_0/Din]
  connect_bd_net -net axi_quad_spi_0_io0_o  [get_bd_pins axi_quad_spi_0/io0_o] \
  [get_bd_ports DISPLAY_MOSI]
  connect_bd_net -net axi_quad_spi_0_sck_o  [get_bd_pins axi_quad_spi_0/sck_o] \
  [get_bd_ports DISPLAY_SCLK]
  connect_bd_net -net axi_quad_spi_0_ss_o  [get_bd_pins axi_quad_spi_0/ss_o] \
  [get_bd_ports DISPLAY_CSn]
  connect_bd_net -net axi_quad_spi_1_io0_o  [get_bd_pins axi_quad_spi_1/io0_o] \
  [get_bd_ports USD_MOSI]
  connect_bd_net -net axi_quad_spi_1_sck_o  [get_bd_pins axi_quad_spi_1/sck_o] \
  [get_bd_ports USD_SCLK]
  connect_bd_net -net axi_quad_spi_1_ss_o  [get_bd_pins axi_quad_spi_1/ss_o] \
  [get_bd_ports USD_CSn]
  ...
  connect_bd_net -net clk_wiz_1_clk_out5  [get_bd_pins clk_wiz_1/clk_out5] \
  [get_bd_pins axi_quad_spi_1/ext_spi_clk]
  connect_bd_net -net clk_wiz_1_locked  [get_bd_pins clk_wiz_1/locked] \
  [get_bd_pins proc_sys_reset_CPU/dcm_locked]
  connect_bd_net -net io1_i_0_1  [get_bd_ports USD_MISO] \
  [get_bd_pins axi_quad_spi_1/io1_i]
  connect_bd_net -net mdm_1_debug_sys_rst  [get_bd_pins mdm_1/Debug_SYS_Rst] \
  [get_bd_pins proc_sys_reset_CPU/mb_debug_sys_rst]
  ...
  [get_bd_pins proc_sys_reset_CPU/slowest_sync_clk] \
  [get_bd_pins smartconnect_CPU/aclk] \
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn  [get_bd_pins proc_sys_reset_DDR3/peripheral_aresetn] \
  [get_bd_pins axi_clock_converter_0/m_axi_aresetn] \
  [get_bd_pins smartconnect_DDR3/aresetn] \
  [get_bd_pins mig_7series_0/aresetn]
  connect_bd_net -net proc_sys_reset_CPU_peripheral_aresetn  [get_bd_pins proc_sys_reset_CPU/peripheral_aresetn] \
  [get_bd_pins smartconnect_CPU/aresetn] \
  ...
  [get_bd_pins IMR_PL_Revision_0/s00_axi_aresetn]
  connect_bd_net -net rst_clk_wiz_1_100M_bus_struct_reset  [get_bd_pins proc_sys_reset_CPU/bus_struct_reset] \
  [get_bd_pins microblaze_0_local_memory/SYS_Rst]
  connect_bd_net -net rst_clk_wiz_1_100M_mb_reset  [get_bd_pins proc_sys_reset_CPU/mb_reset] \
  ...
  [get_bd_pins proc_sys_reset_CPU/ext_reset_in] \
  [get_bd_pins proc_sys_reset_DDR3/ext_reset_in] \
  [get_bd_pins mig_7series_0/sys_rst]
  connect_bd_net -net util_vector_logic_1_Res  [get_bd_pins util_vector_logic_1/Res] \
  [get_bd_pins proc_sys_reset_DDR3/aux_reset_in]
  ...
  [get_bd_pins proc_sys_reset_DDR3/mb_debug_sys_rst]
  ...
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi_quad_spi_0/AXI_LITE/Reg] -force
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi_quad_spi_1/AXI_LITE/Reg] -force
